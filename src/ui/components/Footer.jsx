...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white relative px-6 sm:px-10 pt-12 pb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:gap-28 justify-center gap-10 mb-8">
        <ContactInfo />
        <ScheduleInfo />
      </div>
      <div className="w-full flex flex-col sm:flex-row justify-center items-center sm:justify-around text-center gap-2 sm:gap-0 mt-20">
